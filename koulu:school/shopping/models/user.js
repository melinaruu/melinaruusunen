...
userSchema.methods.checkPassword = async function(password) {
  console.log(password, this.password, ' MIKSI VITUSS ATÄTÄ KUTSTUTAAm');
  return await bcrypt.compare(password, this.password)

  // TODO: 9.5 Implement this
  // Here you should return the result you get from bcrypt.compare() function. Remember to await! B====D
